 ...
 *
 * If no initial directory is provided, the search will start from the current
 * working directory.
 *
 * @param {string} target - The name of the file or directory to find.
 ...
 *
 * @see https://github.com/mnrendra/find-up#readme
 */
const main = (
  target: string,
  initDir: string = cwd()
